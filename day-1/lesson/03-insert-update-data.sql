...
INSERT INTO book (book_id, title, author, publish_date, price) VALUES (1, 'Pride and Prejudice', 'Jane Austen', '1813-01-28', 7.99);

-- MICRO-EXERCISE: Why does this line raise an error? What has to change to fix the error?
INSERT INTO book (book_id, title, author, publish_date, price) VALUES (2, 'Pride and Prejudice', 'Jane Austen', '1813-01-28', 15.50);
...
INSERT INTO book (title, author, publish_date, price) VALUES ('One Hundred Years of Solitude', 'Gabriel García Márquez', '1967-05-05', 8.99);
...
-- Note: PostgreSQL does not have sql_safe_updates. Use transactions for safety.
BEGIN;
UPDATE book SET price=10.99;
ROLLBACK; -- This will undo the update. Use COMMIT to apply changes.

UPDATE book SET price=12.50 WHERE book_id=4; -- Only changes book 4's price.
...
DELETE FROM book WHERE author = 'Truman Capote';
